...
public class MinAbsSumOfTwo {
    ...
    public static void main(String[] args) {
        ...
        int[] A = {1, 4, -3};
        System.out.println("Min Abs Sum of Two is: " + minAbsSumOfTwo.solution(A)); // Output: 1

        int[] B = {-8, 4, 5, -10, 3};
        System.out.println("Min Abs Sum of Two is: " + minAbsSumOfTwo.solution(B)); // Output: 3
    }
