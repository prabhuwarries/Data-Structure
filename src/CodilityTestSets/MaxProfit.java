...
If a single share was bought on day P and sold on day Q, where 0 ≤ P ≤ Q < N, then the profit of such transaction is equal to A[Q] − A[P], if A[Q] ≥ A[P].
...
The Maximum possible profit was 356. It would occur if a share was bought on day 1 and sold on day 5.
...
public class MaxProfit {
    ...
    public static void main (String[] args) {
        ...
        System.out.println(maxProfit.solution(A)); // Output should be 356
    }
}
