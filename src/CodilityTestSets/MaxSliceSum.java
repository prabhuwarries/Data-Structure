...
the result will be an integer within the range [−2,147,483,648..2,147,483,647].package CodilityTestSets;
 */
...
public class MaxSliceSum {
    ...
    public static void main (String[] args) {
        ...
        int[] A = {3, 2, -6, 4, 0};
        System.out.println("Max Slice Sum is: " + maxSliceSum.solution(A));
    }
}
